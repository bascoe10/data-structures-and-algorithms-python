class MinHeap:
    ...
    def __decrease_key(self, idx) -> None:
    ...
    def __heaplify(self, idx) -> None:
        ...
        if right < self.__size and self.__container[right] < self.__container[largest_idx]:
            largest_idx = right

        if largest_idx != idx:
            self.__exchange(idx, largest_idx)
            self.__heaplify(largest_idx)
    ...
    def insert(self, key) -> None:
        ...
        self.__size += 1
        self.__decrease_key(self.__size - 1)
